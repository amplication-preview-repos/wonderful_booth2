...
@InputType()
class AgentAssignmentCreateNestedManyWithoutAgentsInput {
...
export { AgentAssignmentCreateNestedManyWithoutAgentsInput as AgentAssignmentCreateNestedManyWithoutAgentsInput };
